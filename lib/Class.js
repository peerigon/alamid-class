...
(function (root, factory) {
    ...
    function _getMethodWrapper(thisFn, superProto, superFnName) { /*jshint evil: true */
        ...
        switch (length) {
            case 0: return (function () { var prev = this._super, result; this._super = superProto[superFnName]; result = thisFn.call(this); this._super = prev; return result; });
            case 1: return (function (a) { var prev = this._super, result; this._super = superProto[superFnName]; result = thisFn.call(this, a); this._super = prev; return result; });
            case 2: return (function (a, b) { var prev = this._super, result; this._super = superProto[superFnName]; result = thisFn.call(this, a, b); this._super = prev; return result; });
            case 3: return (function (a, b, c) { var prev = this._super, result; this._super = superProto[superFnName]; result = thisFn.call(this, a, b, c); this._super = prev; return result; });
            case 4: return (function (a, b, c, d) { var prev = this._super, result; this._super = superProto[superFnName]; result = thisFn.call(this, a, b, c, d); this._super = prev; return result; });
        }
