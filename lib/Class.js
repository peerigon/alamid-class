...
(function (root, factory) {
        ...
        for (i = 0; i < sources.length; i++) {
            ...
            for (key in source) {
                ...
                if (key !== "constructor" && typeof value === "function" && typeof superFn === "function") {
                    value = _getMethodWrapper(value, superFn);
                }
                prototype[key] = value;
            }
        }
     ...
     * @return {Function}
     */
    function _getMethodWrapper(thisFn, superFn) { /*jshint evil: true */
        var length = thisFn.length,
            evalResult;

        // Shortcuts for common use-cases because eval is slower in some browsers
        switch (length) {
            case 0: return (function () { var prev = this._super, result; this._super = superFn; result = thisFn.call(this); this._super = prev; return result; });
            case 1: return (function (a) { var prev = this._super, result; this._super = superFn; result = thisFn.call(this, a); this._super = prev; return result; });
            case 2: return (function (a, b) { var prev = this._super, result; this._super = superFn; result = thisFn.call(this, a, b); this._super = prev; return result; });
            case 3: return (function (a, b, c) { var prev = this._super, result; this._super = superFn; result = thisFn.call(this, a, b, c); this._super = prev; return result; });
            case 4: return (function (a, b, c, d) { var prev = this._super, result; this._super = superFn; result = thisFn.call(this, a, b, c, d); this._super = prev; return result; });
        }
    ...
    function _createClassFunction(name, prototype, SuperClass) { /*jshint evil: true */
        ...
        if (name === "AnonymousClass") {
            switch (length) {
                case 0: return (function AnonymousClass() { _initClass.call(this, prototype, AnonymousClass, SuperClass, arguments); });
                // a, b, c, d are applied as well so code-minimizer don't strip them away
                case 1: return (function AnonymousClass(a) { _initClass.call(this, prototype, AnonymousClass, SuperClass, arguments, a); });
                case 2: return (function AnonymousClass(a, b) { _initClass.call(this, prototype, AnonymousClass, SuperClass, arguments, a, b); });
                case 3: return (function AnonymousClass(a, b, c) { _initClass.call(this, prototype, AnonymousClass, SuperClass, arguments, a, b, c); });
                case 4: return (function AnonymousClass(a, b, c, d) { _initClass.call(this, prototype, AnonymousClass, SuperClass, arguments, a, b, c, d); });
            }
        }

        eval("evalResult = (function " + name + "(" + _getArgList(length) + ") { _initClass.call(this, prototype, " + name + ", SuperClass, arguments); })");
        return evalResult;
    }
     ...
     */
    function _initClass(prototype, NewClass, SuperClass, args) { /*jshint validthis: true */
