...
(function (root, factory) {
    ...
    function _createClassFunction(name, length) { /*jshint evil: true */
        ...
        if (name === "AnonymousClass") {
            switch (length) {
                case 0: return (function AnonymousClass() { this.constructor.apply(this, arguments); });
                // a, b, c, d are applied as well so code-minimizer don't strip them away
                case 1: return (function AnonymousClass(a) { this.constructor.apply(this, arguments, a); });
                case 2: return (function AnonymousClass(a, b) { this.constructor.apply(this, arguments, a, b); });
                case 3: return (function AnonymousClass(a, b, c) { this.constructor.apply(this, arguments, a, b, c); });
                case 4: return (function AnonymousClass(a, b, c, d) { this.constructor.apply(this, arguments, a, b, c, d); });
            }
        }

        eval("evalResult = (function " + name + "(" + _getArgList(length) + ") { this.constructor.apply(this, arguments); })");
        return evalResult;
    }
